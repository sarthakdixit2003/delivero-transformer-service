...
def mask_data(
    value: JSONValue, errors: ErrorCollector, mask_strategy: MaskTypes = "last4"
) -> Union[str, None]:
    """
...
def evaluate_condition(
    condition: ConditionSchema, payload: JSONValue, errors: ErrorCollector
) -> bool:
    """
...
def transform_data(
    value: JSONValue, transform_type: TransformTypes, errors: ErrorCollector
) -> JSONValue:
